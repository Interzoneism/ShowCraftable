...
public class GuiScreenLoadingGame : GuiScreen
{
	...
	public override void RenderToDefaultFramebuffer(float dt)
	{
		...
		ScreenManager.api.Render.Render2DTexturePremultipliedAlpha(versionNumberTexture.TextureId, num - (float)versionNumberTexture.Width - 10f, num2 - (float)versionNumberTexture.Height - 10f, versionNumberTexture.Width, versionNumberTexture.Height);
		if (loadingShaders)
		{

...
public class Matrixf
{
	...
	{
		Mat4f.RotateX(Values, Values, degrees.X * ((float)Math.PI / 180f));
		Mat4f.RotateY(Values, Values, degrees.Y * ((float)Math.PI / 180f));
		Mat4f.RotateZ(Values, Values, degrees.Z * ((float)Math.PI / 180f));
		return this;
	}
	...
	{
		Mat4f.RotateX(Values, Values, degX * ((float)Math.PI / 180f));
		return this;
	}

	public Matrixf RotateYDeg(float degY)
	{
		Mat4f.RotateY(Values, Values, degY * ((float)Math.PI / 180f));
		return this;
	}

	public Matrixf RotateZDeg(float degZ)
	{
		Mat4f.RotateZ(Values, Values, degZ * ((float)Math.PI / 180f));
		return this;
	}

...
public class Shape
{
	...
	public ShapeElement FindElement(string wildcard, StringComparison stringComparison = StringComparison.OrdinalIgnoreCase)
	{
		...
		return GetElementByName(wildcard, Elements, isWildcard: true);
	}
	...
	public ShapeElement GetElementByName(string name, StringComparison stringComparison = StringComparison.OrdinalIgnoreCase)
	{
		...
		return GetElementByName(name, Elements, isWildcard: false);
	}

	private ShapeElement GetElementByName(string name, ShapeElement[] elems, bool isWildcard)
	{
		foreach (ShapeElement shapeElement in elems)
		{
			...
			if (shapeElement.Children != null)
			{
				ShapeElement elementByName = GetElementByName(name, shapeElement.Children, isWildcard);
				if (elementByName != null)
				{

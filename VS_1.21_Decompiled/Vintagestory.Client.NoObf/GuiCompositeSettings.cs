...
public class GuiCompositeSettings : GuiComposite
{
	...
	{
		if (ClientSettings.DynamicColorGrading && composer != null)
		{
			DefaultShaderUniforms shaderUniforms = ScreenManager.Platform.ShaderUniforms;
			if (shaderUniforms != null)
			{
				composer.GetSlider("sepiaSlider")?.SetValue((int)(shaderUniforms.SepiaLevel * 100f));
				composer.GetSlider("contrastSlider")?.SetValue((int)(shaderUniforms.ExtraContrastLevel * 100f) + 100);
			}
		}
	}
	...
	internal void OnGraphicsOptions(bool on)
	{
		...
		GuiComposer guiComposer = ComposerHeader("gamesettings-graphics", "graphics").AddRichtext(new RichTextComponentBase[1]
		{
			new LinkTextComponent(handler.Api, text, CairoFont.WhiteDetailText(), OnMoreOptions)
		}, elementBounds3 = elementBounds3.FlatCopy()).AddStaticText(Lang.Get("setting-column-appear"), cairoFont, elementBounds3 = elementBounds3.BelowCopy(0.0, 10.0).WithFixedWidth(250.0)).AddStaticText(Lang.Get("setting-name-gamma"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, -4.0).WithFixedWidth(200.0))
			...
			.AddStaticText(Lang.Get("setting-name-dynamiccolorgrading"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, -8.0))
			...
			.AddStaticText(Lang.Get("setting-name-contrast"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, 10.0))
			.AddSlider(onContrastChanged, elementBounds4 = elementBounds4.BelowCopy(0.0, 21.0).WithFixedSize(num, 20.0), "contrastSlider")
			.AddHoverText(array[17], CairoFont.WhiteSmallText(), 250, elementBounds3.FlatCopy().WithFixedHeight(25.0))
		...
		{
			GuiComposer guiComposer2 = composer.AddStaticText(Lang.Get("setting-name-maxfps"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, -3.0).WithFixedHeight(40.0)).AddSlider(onMaxFpsChanged, elementBounds4 = elementBounds4.BelowCopy(0.0, 15.0).WithFixedSize(num, 20.0), "maxFpsSlider").AddHoverText(array[5], CairoFont.WhiteSmallText(), 250, elementBounds3.FlatCopy().WithFixedHeight(25.0))
			...
			ElementBounds elementBounds6 = elementBounds4.BelowCopy(0.0, 18.0).WithFixedSize(num, 26.0);
			GuiComposer guiComposer3 = GuiComposerHelpers.AddDropDown(bounds: elementBounds4 = elementBounds6.BelowCopy(0.0, 18.0).WithFixedSize(num, 26.0), composer: guiComposer2.AddDropDown(values2, names2, vsyncMode, onSelectionChanged, elementBounds6, "vsyncMode").AddStaticText(Lang.Get("setting-name-optimizeram"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, 4.0)).AddHoverText(array[19], CairoFont.WhiteSmallText(), 250, elementBounds3.FlatCopy().WithFixedHeight(25.0)), values: new string[2] { "1", "2" }, names: new string[2]
			{
				...
				.AddStaticText(Lang.Get("setting-name-lodbiasfar"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, 4.0))
				.AddHoverText(Lang.Get("setting-hover-lodbiasfar"), CairoFont.WhiteSmallText(), 250, elementBounds3.FlatCopy().WithFixedHeight(25.0));
			ActionConsumable<int> onNewSliderValue2 = onLodbiasFarChanged;
			ElementBounds elementBounds7 = elementBounds4.BelowCopy(0.0, 21.0).WithFixedSize(num, 20.0);
			GuiComposerHelpers.AddDropDown(bounds: elementBounds4 = elementBounds7.BelowCopy(0.0, 18.0).WithFixedSize(num, 26.0), composer: guiComposer3.AddSlider(onNewSliderValue2, elementBounds7, "lodbiasfarSlider").AddStaticText(Lang.Get("setting-name-windowborder"), CairoFont.WhiteSmallishText(), elementBounds3 = elementBounds3.BelowCopy(0.0, 4.0)), values: new string[3] { "0", "1", "2" }, names: new string[3]
			{
				Lang.Get("windowborder-resizable"),
				Lang.Get("windowborder-fixed"),
				Lang.Get("windowborder-hidden")
			}, selectedIndex: (int)ScreenManager.Platform.WindowBorder, onSelectionChanged: OnWindowBorderChanged, key: "windowBorder");
		}
		...
		if (ClientSettings.ShowMoreGfxOptions)
		{
			GuiComposer guiComposer4 = composer.AddStaticText(Lang.Get("setting-name-smoothshadows"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy()).AddHoverText(array[7], CairoFont.WhiteSmallText(), 250, elementBounds.FlatCopy().WithFixedHeight(25.0)).AddSwitch(onSmoothShadowsToggled, elementBounds2 = elementBounds2.BelowCopy(0.0, 15.0), "smoothShadowsLever")
			...
			Action<bool> onToggle = onBloomChanged;
			ElementBounds elementBounds8 = elementBounds2.BelowCopy(0.0, 12.0);
			GuiComposerHelpers.AddDropDown(bounds: elementBounds2 = elementBounds8.BelowCopy(0.0, 18.0).WithFixedSize(num, 26.0), composer: guiComposer4.AddSwitch(onToggle, elementBounds8, "BloomSwitch").AddStaticText(Lang.Get("setting-name-clouds"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy().WithFixedHeight(39.0)).AddHoverText(Lang.Get("settings-hover-clouds"), CairoFont.WhiteSmallText(), 250, elementBounds.FlatCopy().WithFixedHeight(25.0)), values: new string[3] { "0", "1", "2" }, names: new string[3]
			{
				Lang.Get("settings-clouds-off"),
				Lang.Get("settings-clouds-volumetric"),
				Lang.Get("settings-clouds-classic")
			}, selectedIndex: ClientSettings.CloudRenderMode, onSelectionChanged: onCloudsChanged, key: "clouds").AddStaticText(Lang.Get("setting-name-godrays"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy(0.0, 3.0).WithFixedHeight(39.0)).AddSwitch(onGodRaysToggled, elementBounds2 = elementBounds2.BelowCopy(0.0, 15.0).WithFixedSize(num, 20.0), "godraySwitch")
				.AddHoverText(array[12], CairoFont.WhiteSmallText(), 250, elementBounds.FlatCopy().WithFixedHeight(25.0))
				.AddStaticText(Lang.Get("setting-name-ssao"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy(0.0, 4.0).WithFixedHeight(36.0))
				...
				.AddStaticText(Lang.Get("setting-name-shadows"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy(0.0, 4.0))
				...
				.AddStaticText(Lang.Get("setting-name-dynalight"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy(0.0, 4.0))
				...
				.AddStaticText(Lang.Get("setting-name-resolution"), CairoFont.WhiteSmallishText(), elementBounds = elementBounds.BelowCopy(0.0, 4.0))
	...
	private void onDynamicGradingToggled(bool on)
	{
		...
		composer.GetSlider("sepiaSlider").SetValue((int)(ScreenManager.Platform.ShaderUniforms.SepiaLevel * 100f));
		composer.GetSlider("sepiaSlider").Enabled = !ClientSettings.DynamicColorGrading;
		composer.GetSlider("contrastSlider").SetValue((int)(ScreenManager.Platform.ShaderUniforms.ExtraContrastLevel * 100f) + 100);
	...
	private void SetGfxValues()
	{
		...
		if (ClientSettings.ShowMoreGfxOptions)
		{
			...
			composer.GetDropDown("windowModeSwitch").SetSelectedIndex(ClientSettings.CloudRenderMode);
		...
		composer.GetSlider("sepiaSlider").SetValues((int)(ScreenManager.Platform.ShaderUniforms.SepiaLevel * 100f), 0, 100, 5);
		composer.GetSlider("sepiaSlider").Enabled = !ClientSettings.DynamicColorGrading;
		composer.GetSlider("contrastSlider").SetValues((int)(ScreenManager.Platform.ShaderUniforms.ExtraContrastLevel * 100f) + 100, 100, 200, 10, "%");
		composer.GetSlider("contrastSlider").Enabled = !ClientSettings.DynamicColorGrading;
	...
	private void LoadMouseCombinations()
	{
		...
		for (int num4 = 9; num4 < array.Length; num4++)
		{
			mousecontrolItems.AddRange(array[num4]);
		}
	}
	...
	private void LoadKeyCombinations()
	{
		...
		for (int num4 = 0; num4 < array.Length; num4++)
		{
			...
			if ((num4 == 1 && !ClientSettings.SeparateCtrl) || num4 == 9)
			{
				continue;
			}
			if (flag)
			{
				foreach (ConfigItem item in array[num4])
				{
			...
			keycontrolItems.AddRange(flag ? list : array[num4]);
		}
	}

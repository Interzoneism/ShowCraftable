...
public class AudioMetaData : AudioData
{
	...
	private void DoLoad()
	{
		...
		AudioMetaData audioMetaData = (AudioMetaData)ScreenManager.Platform.CreateAudioData(Asset);
		Pcm = audioMetaData.Pcm;
		Channels = audioMetaData.Channels;
		Rate = audioMetaData.Rate;
		BitsPerSample = audioMetaData.BitsPerSample;
		Asset.Data = null;
		Loaded = 2;
		lock (this)
		{

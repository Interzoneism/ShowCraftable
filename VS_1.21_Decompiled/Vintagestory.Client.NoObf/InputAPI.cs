...
public class InputAPI : IInputAPI
{
	...
	public bool IsHotKeyPressed(HotKey hotKey)
	{
		...
		bool flag = !hotKey.CurrentMapping.SecondKeyCode.HasValue || KeyboardKeyState[hotKey.CurrentMapping.SecondKeyCode.Value];
		bool flag2 = !hotKey.CurrentMapping.Alt || KeyboardKeyState[5];
		bool flag3 = !hotKey.CurrentMapping.Ctrl || KeyboardKeyState[3];
		bool flag4 = !hotKey.CurrentMapping.Shift || KeyboardKeyState[1];

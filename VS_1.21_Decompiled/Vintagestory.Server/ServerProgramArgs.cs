...
public class ServerProgramArgs
{
	...
	[Option("reducedthreads", HelpText = "If specified, the server aims to use approximately 20% fewer threads in total, where possible, without greatly reducing performance")]
	public bool ReducedThreads { get; set; }
	...
	public string GetUsage(ParserResult<ServerProgramArgs> parser)
	{
		...
		obj.Heading = "Vintage Story Server 1.21.0";

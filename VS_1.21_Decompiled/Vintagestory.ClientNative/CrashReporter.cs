...
public class CrashReporter
{
	...
	public void Crash(Exception exCrash)
	{
		...
		try
		{
			...
			IEnumerable<ModContainer> source = LoadedMods.Where((ModContainer mod) => mod.Assembly != null && mod.Assembly.GetCustomAttribute<AssemblyCopyrightAttribute>()?.Copyright != "Copyright © 2016-2024 Anego Studios");

...
public class BlockDisplayCase : Block
{
	...
	{
		if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is BlockEntityDisplayCase blockEntityDisplayCase)
		{
			return blockEntityDisplayCase.OnInteract(byPlayer, blockSel);
		}

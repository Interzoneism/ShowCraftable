...
public class BlockEntitySign : BlockEntity, IRotatable
{
	...
	public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldForResolving)
	{
		...
		fontSize = tree.GetFloat("fontSize", blockSign?.signConfig?.FontSize ?? 20f);
	...
	public override void OnReceivedServerPacket(int packetid, byte[] data)
	{
		...
		if (packetid == 1000)
		{
			...
			if (signRenderer != null)
			{
				signRenderer.fontSize = editSignPacket.FontSize;
				signRenderer.SetNewText(editSignPacket.Text, color);
			}
		}
	}

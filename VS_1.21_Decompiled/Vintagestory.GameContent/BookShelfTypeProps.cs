...
public class BookShelfTypeProps : IShapeTypeProps
{
	...
	public Cuboidf[] ColSelBoxes
	{
		get
		{
			return group.ColSelBoxes;
		}
		set
		{
			group.ColSelBoxes = value;
		}
	}
	...
	public ModelTransform FpTtransform
	{
		get
		{
			return group.FpTf;
	...
	public ModelTransform TpTransform
	{
		get
		{
			return group.TpTf;
	...
	public ModelTransform GroundTransform
	{
		get
		{
			return group.GroundTf;
		}
		set
		{
			group.GroundTf = value;
		}
	}

	public string RotInterval
	{
		get
		{
			return group.RotInterval;
		}
		set
		{
			group.RotInterval = value;
		}
	}
	...
	public Dictionary<long, Cuboidf[]> ColSelBoxesByHashkey
	{
		get
		{
			return group.ColSelBoxesByHashkey;
		}
		set
		{
			group.ColSelBoxesByHashkey = value;
		}
	}
	...
	public AssetLocation ShapePath
	{
		get
		{
			if (Variant.Contains("doublesided"))
			{
				if (Type1 == null)
				{
					int index = rnd.Next(group.typesByCode.Count);
					Type1 = group.typesByCode.GetKeyAtIndex(index);
				}
	...
	public AssetLocation ShapePath2
	{
		get
		{
			if (Variant.Contains("doublesided"))
			{
				...
				{
					int index = rnd.Next(group.typesByCode.Count);
					Type2 = group.typesByCode.GetKeyAtIndex(index);
				}
	...
	BlockDropItemStack[] IShapeTypeProps.Drops
	{
		get
		{

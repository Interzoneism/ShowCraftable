...
public class BlockFence : Block
{
	...
	public bool ShouldConnectAt(IWorldAccessor world, BlockPos ownPos, BlockFacing side)
	{
		...
		if (!(block is BlockFence) && (!(block is BlockFenceGate blockFenceGate) || blockFenceGate.GetDirection() == side || blockFenceGate.GetDirection() == side.Opposite) && (!(block is BlockFenceGateRoughHewn blockFenceGateRoughHewn) || blockFenceGateRoughHewn.GetDirection() == side || blockFenceGateRoughHewn.GetDirection() == side.Opposite))
		{

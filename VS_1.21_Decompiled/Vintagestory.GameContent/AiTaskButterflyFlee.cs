...
public class AiTaskButterflyFlee : AiTaskButterflyWander
{
	...
	public AiTaskButterflyFlee(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig)
		...
		: base(entity, JsonObject.FromJson("{}"), JsonObject.FromJson("{}"))
	{
		...
		taskConfig = JsonObject.FromJson("{}");
	}
	...
	{
		float num = (float)Math.Atan2(fleeFromEntity.ServerPos.X - entity.ServerPos.X, fleeFromEntity.ServerPos.Z - entity.ServerPos.Z);
		tmpVec = tmpVec.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z);
		tmpVec.Ahead(0.9, 0f, num + (float)Math.PI / 2f);
		if (traversable(tmpVec))
		{
			targetPos.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z).Ahead(10.0, 3f, num + (float)Math.PI / 2f);
			return;
		}
		tmpVec = tmpVec.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z);
		tmpVec.Ahead(0.9, 0f, num + (float)Math.PI);
		if (traversable(tmpVec))
		{
			targetPos.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z).Ahead(10.0, 3f, num + (float)Math.PI);
			return;
		}
		tmpVec = tmpVec.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z);
		tmpVec.Ahead(0.9, 0f, num);
		if (traversable(tmpVec))
		{
			targetPos.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z).Ahead(10.0, 3f, num);
			return;
		}
		tmpVec = tmpVec.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z);
		tmpVec.Ahead(0.9, 0f, 0f - num);
		targetPos.Set(entity.ServerPos.X, entity.ServerPos.Y, entity.ServerPos.Z).Ahead(10.0, 0f, 0f - num);
	}

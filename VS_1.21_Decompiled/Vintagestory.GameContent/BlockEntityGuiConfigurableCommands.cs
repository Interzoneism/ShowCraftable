...
public class BlockEntityGuiConfigurableCommands : BlockEntityCommands
{
	...
	{
		BlockEntityCommandPacket blockEntityCommandPacket = SerializerUtil.Deserialize<BlockEntityCommandPacket>(data);
		Commands = blockEntityCommandPacket.Commands;
		Silent = blockEntityCommandPacket.Silent;

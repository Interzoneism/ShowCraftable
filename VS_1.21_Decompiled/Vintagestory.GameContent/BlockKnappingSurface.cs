...
public class BlockKnappingSurface : Block
{
	...
	{
		if (blockAccessor.GetBlockEntity(pos) is BlockEntityKnappingSurface blockEntityKnappingSurface)
		{
			return blockEntityKnappingSurface.GetSelectionBoxes(blockAccessor, pos);
		}

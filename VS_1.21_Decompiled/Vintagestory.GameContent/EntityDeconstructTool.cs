...
public class EntityDeconstructTool : CollectibleBehavior
{
	...
	public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, ref EnumHandling handling)
	{
		...
		if (world.Side == EnumAppSide.Server)
		{
			...
			{
				if (jsonItemStack.Resolve(world, string.Concat(byEntity.Code, " entity deconstruction drop.")))
				{
					world.SpawnItemEntity(jsonItemStack.ResolvedItemstack, entitySel.Entity.ServerPos.XYZ);
				}
			}
		}

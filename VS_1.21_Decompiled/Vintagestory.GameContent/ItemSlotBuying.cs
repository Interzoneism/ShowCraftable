...
public class ItemSlotBuying : ItemSlotSurvival
{
	...
	{
		IHeldBag heldBag = itemstackFromSourceSlot.Itemstack?.Collectible.GetCollectibleInterface<IHeldBag>() ?? null;
		if (base.CanHold(itemstackFromSourceSlot) && (heldBag == null || heldBag.IsEmpty(itemstackFromSourceSlot.Itemstack)))
		{

...
public class AiTaskButterflyFeedOnFlowers : AiTaskBase
{
	...
	public AiTaskButterflyFeedOnFlowers(EntityAgent entity, JsonObject taskConfig, JsonObject aiConfig)
	...
	public override bool ShouldExecute()
	{
		...
		if (block.Attributes["butterflyFeed"].AsBool())
		{
			...
			double y = block.Attributes["sitHeight"].AsDouble(block.TopMiddlePos.Y);
			EnumWindBitMode value = (EnumWindBitMode)block.Attributes["butteflyWindMode"].AsInt(2);
			entity.WatchedAttributes.SetInt("windMode", (int)value);
			MainTarget = tmpPos.ToVec3d().Add(block.TopMiddlePos.X, y, block.TopMiddlePos.Z);
			return true;
		}
		return false;
	}

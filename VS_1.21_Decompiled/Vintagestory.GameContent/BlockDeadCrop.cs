...
public class BlockDeadCrop : Block, IDrawYAdjustable
{
	...
	{
		if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityDeadCrop blockEntityDeadCrop)
		{
			return blockEntityDeadCrop.GetDrops(byPlayer, dropQuantityMultiplier);
		}
	...
	public override string GetPlacedBlockName(IWorldAccessor world, BlockPos pos)
	{
		if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityDeadCrop blockEntityDeadCrop)
		{
			return blockEntityDeadCrop.GetPlacedBlockName();
		}

...
public class EntityEchoChamber : EntityAgent
{
	...
	public override void Initialize(EntityProperties properties, ICoreAPI api, long InChunkIndex3d)
	{
		...
		{
			capi = coreClientAPI;
			echoChamberSound1 = coreClientAPI.World.LoadSound(new SoundParams
			{
			...
			echoChamberSound2 = coreClientAPI.World.LoadSound(new SoundParams
			{
				DisposeOnFinish = false,
				Location = new AssetLocation("sounds/effect/echochamber.ogg"),
			...
			echoChamberSound3 = coreClientAPI.World.LoadSound(new SoundParams
			{
				DisposeOnFinish = false,
	...
	public override void OnGameTick(float dt)
	{
		...
		{
			accum = 0.0;
			double num = capi.World.Player.Entity.Pos.HorDistanceTo(Pos) - 35.0;
			double newVolume = GameMath.Clamp((20.0 - num) / 20.0, 0.0, 1.0);
			echoChamberSound2.FadeTo(newVolume, 2f, null);
			echoChamberSound3.FadeTo(newVolume, 2f, null);
		}
		base.OnGameTick(dt);
	}

...
public class ItemPadlock : Item
{
	...
	public override void OnLoaded(ICoreAPI api)
	{
		...
		interactions = ObjectCacheUtil.GetOrCreate(api, "padlockInteractions", delegate
		{
			...
			{
				if (!(block.Code == null) && block.HasBehavior<BlockBehaviorLockable>(withInheritance: true) && block.CreativeInventoryTabs != null && block.CreativeInventoryTabs.Length != 0)
				{

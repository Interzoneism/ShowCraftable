...
public class BlockSnowLayer : BlockLayered
{
	...
	public override bool ShouldReceiveServerGameTicks(IWorldAccessor world, BlockPos pos, Random offThreadRandom, out object extra)
	{
		...
		ClimateCondition climateAt = world.BlockAccessor.GetClimateAt(pos);
		if (climateAt != null)
		{
			return offThreadRandom.NextDouble() < (double)GameMath.Clamp((climateAt.Temperature - 0.5f) / (15f - 10f * climateAt.Rainfall), 0f, 1f);
		}
		return false;
	}

...
public class BlockLayeredSlowDig : Block
{
	...
	{
		int.TryParse(Variant[layerGroupCode], out var result);
		return result;
	}
	...
	public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
	{
		...
		if (world.BlockAccessor.GetBlock(blockSel.Position.AddCopy(blockSel.Face.Opposite)) is BlockLayeredSlowDig blockLayeredSlowDig)
		{
	...
	{
		Block prevLayer = GetPrevLayer(world);
		if (prevLayer != null)
		{
			...
			{
				world.BlockAccessor.SetBlock(prevLayer.BlockId, pos);
			}
			else
			{

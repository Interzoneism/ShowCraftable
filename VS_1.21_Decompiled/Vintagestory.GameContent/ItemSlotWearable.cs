...
public class ItemSlotWearable : ItemSlot
{
	...
	public bool IsDressType(ItemStack itemstack, string[] slotWearableCodes)
	{
		...
		IAttachableToEntity attachableToEntity = IAttachableToEntity.FromCollectible(itemstack.Collectible);
		if (attachableToEntity != null)
		{
			return slotWearableCodes.IndexOf(attachableToEntity.GetCategoryCode(itemstack)) >= 0;
		}
		return false;
	}
}

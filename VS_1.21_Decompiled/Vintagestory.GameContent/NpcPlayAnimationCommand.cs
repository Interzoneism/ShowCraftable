...
public class NpcPlayAnimationCommand : INpcCommand
{
	...
	public void Stop()
	{
		entity.Properties.Client.AnimationsByMetaCode.TryGetValue(AnimCode, out var value);
		if (value != null && value.Code != null)
		{
			entity.AnimManager.StopAnimation(value.Code);
		}
		else
		{
	...
	public bool IsFinished()
	{
		...
		{
			if (value != null && value.Animation != null)
			{
				return !entity.AnimManager.ActiveAnimationsByAnimCode.ContainsKey(value?.Animation);
			}
			return true;
		}
		return false;

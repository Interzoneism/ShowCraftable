...
public class EntityBehaviorIdleAnimations : EntityBehavior
{
	...
	public override void OnGameTick(float dt)
	{
		...
		bool flag = eagent.ServerControls.TriesToMove;
		if (eagent.MountedOn != null)
		{
			flag |= eagent.MountedOn.MountSupplier.Position.Motion.LengthSq() > 9.999999747378752E-05;
		}
		if (!flag && !eagent.Controls.IsFlying && !eagent.Controls.Gliding)
		{

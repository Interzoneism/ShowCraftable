...
public class JumpAction : EntityActionBase
{
	...
	public override void AddGuiEditFields(ICoreClientAPI capi, GuiComposer singleComposer)
	{
		...
		singleComposer.AddStaticText("Jump to Action Index", CairoFont.WhiteDetailText(), elementBounds).AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "index").AddStaticText("Until hour of day (0..24, -1 to ignore)", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 15.0))
			.AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "hourOfDay")
			.AddStaticText("OR amount of min repetitions (-1 to ignore)", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 15.0))
			.AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "minrepetitions")
			.AddStaticText("+ max repetitions (-1 to ignore)", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 5.0))
			.AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "maxrepetitions");

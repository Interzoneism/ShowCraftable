...
public class BlockEntityTeleporter : BlockEntityTeleporterBase
{
	...
	private void OnClientGameTick(float dt)
	{
		if (ownBlock != null && Api?.World != null)
		{
			...
			SimpleParticleProperties simpleParticleProperties = ((Api.World.ElapsedMilliseconds > 100 && Api.World.ElapsedMilliseconds - lastOwnPlayerCollideMs < 100) ? ownBlock.insideParticles : ownBlock.idleParticles);
			simpleParticleProperties.MinPos = posvec;

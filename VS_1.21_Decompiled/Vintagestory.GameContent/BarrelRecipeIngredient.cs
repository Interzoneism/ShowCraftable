...
public class BarrelRecipeIngredient : CraftingRecipeIngredient
{
	...
	{
		BarrelRecipeIngredient barrelRecipeIngredient = new BarrelRecipeIngredient
		{
		...
		if (Attributes != null)
		{
			barrelRecipeIngredient.Attributes = Attributes.Clone();
		}
		return barrelRecipeIngredient;
	}

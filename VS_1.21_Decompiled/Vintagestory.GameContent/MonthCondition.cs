...
public class MonthCondition : IActionCondition, IStorableTypedComponent
{
	...
	public void AddGuiEditFields(ICoreClientAPI capi, GuiComposer singleComposer)
	{
		...
		singleComposer.AddStaticText("Month (1..12)", CairoFont.WhiteDetailText(), elementBounds).AddTextInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "month");

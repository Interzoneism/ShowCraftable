...
public static class DepositGeneratorRegistry
{
	...
	public static DepositGeneratorBase CreateGenerator(string code, JsonObject attributes, params object[] args)
	{
		...
		DepositGeneratorBase depositGeneratorBase = Activator.CreateInstance(Generators[code], args) as DepositGeneratorBase;
		attributes.Token.Populate(depositGeneratorBase);
		depositGeneratorBase.Init();
		return depositGeneratorBase;
	}
}

...
public class Packet_ClientHandInteractionSerializer
{
	...
	{
		Packet_ClientHandInteraction packet_ClientHandInteraction = new Packet_ClientHandInteraction();
		DeserializeLengthDelimited(stream, packet_ClientHandInteraction);
	...
	public static int GetSize(Packet_ClientHandInteraction instance)
	{
		...
		if (instance.UseType != 0)
		{
			num += ProtocolParser.GetSize(instance.UseType) + 1;
		}
		if (instance.MouseButton != 0)
		{
		...
		if (instance.OnEntityId != 0L)
		{
			num += ProtocolParser.GetSize(instance.OnEntityId) + 1;
		}
		if (instance.EnumHandInteract != 0)
		{
			num += ProtocolParser.GetSize(instance.EnumHandInteract) + 1;
		}
		if (instance.UsingCount != 0)
		{
			num += ProtocolParser.GetSize(instance.UsingCount) + 1;
		}
		if (instance.SelectionBoxIndex != 0)
		{
		...
		if (instance.CancelReason != 0)
		{
			num += ProtocolParser.GetSize(instance.CancelReason) + 2;
		}
		if (instance.FirstEvent != 0)
		{
			num += ProtocolParser.GetSize(instance.FirstEvent) + 2;
		}
		instance.size = num;
		return num;
	}

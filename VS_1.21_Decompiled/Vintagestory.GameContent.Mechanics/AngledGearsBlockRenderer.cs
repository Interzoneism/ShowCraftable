...
public class AngledGearsBlockRenderer : MechBlockRenderer
{
		...
		: base(capi, mechanicalPowerMod)
	{
		...
		modeldata2.CustomFloats = (floatsPeg = new CustomMeshDataPartFloat(202000)
		{
			Instanced = true,
	...
	{
		if (dev is BEBehaviorMPAngledGears bEBehaviorMPAngledGears)
		{
			BlockFacing propagationDirection = bEBehaviorMPAngledGears.GetPropagationDirection();
			if (propagationDirection == bEBehaviorMPAngledGears.axis1 || propagationDirection == bEBehaviorMPAngledGears.axis2)
			{

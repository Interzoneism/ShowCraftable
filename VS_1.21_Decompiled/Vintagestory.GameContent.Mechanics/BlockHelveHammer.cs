...
public class BlockHelveHammer : Block
{
	...
	{
		if (world.BlockAccessor.GetBlockEntity(blockSel.Position) is BEHelveHammer { HammerStack: null } bEHelveHammer && !byPlayer.InventoryManager.ActiveHotbarSlot.Empty && byPlayer.InventoryManager.ActiveHotbarSlot.Itemstack.Collectible.FirstCodePart().Equals("helvehammer"))
		{

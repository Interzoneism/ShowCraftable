...
public class BEBehaviorMPArchimedesScrew : BEBehaviorMPBase
{
	...
	public bool IsAttachedToBlock()
	{
		for (int i = 0; i < BlockFacing.HORIZONTALS.Length; i++)
		{
			...
			Block blockOnSide = Api.World.BlockAccessor.GetBlockOnSide(Position, blockFacing);
			if (base.Block != blockOnSide && blockOnSide.SideSolid[blockFacing.Opposite.Index])
			{
				return true;
			}
		}

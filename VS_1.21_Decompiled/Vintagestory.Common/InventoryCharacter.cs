...
public class InventoryCharacter : InventoryBasePlayer
{
	...
	{
		ItemSlotCharacter itemSlotCharacter = new ItemSlotCharacter((EnumCharacterDressType)slotId, this);
		iconByDressType.TryGetValue((EnumCharacterDressType)slotId, out itemSlotCharacter.BackgroundIcon);

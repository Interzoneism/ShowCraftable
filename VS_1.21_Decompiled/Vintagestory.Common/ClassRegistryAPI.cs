...
public class ClassRegistryAPI : IClassRegistryAPI
{
	...
	{
		registry.blockbehaviorToTypeMapping.TryGetValue(blockclass, out var value);
		return value;
	}
	...
	public JsonTreeAttribute CreateJsonTreeAttributeFromDict(Dictionary<string, JsonTreeAttribute> attributes)
	{
		...
		jsonTreeAttribute.type = EnumAttributeType.Tree;
		foreach (KeyValuePair<string, JsonTreeAttribute> attribute in attributes)
		{
			jsonTreeAttribute.elems[attribute.Key] = attribute.Value.Clone();
		}
		return jsonTreeAttribute;
	}
	...
	{
		registry.blockEntityClassnameToTypeMapping.TryGetValue(blockEntityClass, out var value);
		return value;
	}
	...
	{
		registry.blockEntityTypeToClassnameMapping.TryGetValue(type, out var value);
		return value;
	}
	...
	{
		registry.blockentitybehaviorToTypeMapping.TryGetValue(name, out var value);
		return value;
	}

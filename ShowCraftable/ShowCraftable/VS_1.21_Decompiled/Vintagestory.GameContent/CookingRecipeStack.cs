...
public class CookingRecipeStack : JsonItemStack
{
	...
	{
		CookingRecipeStack cookingRecipeStack = new CookingRecipeStack
		{
			Code = Code.Clone(),
		...
		if (Attributes != null)
		{
			cookingRecipeStack.Attributes = Attributes.Clone();
		}
		cookingRecipeStack.ShapeElement = ShapeElement;
		return cookingRecipeStack;
	}
}

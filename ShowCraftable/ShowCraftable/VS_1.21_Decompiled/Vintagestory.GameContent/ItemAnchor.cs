...
public class ItemAnchor : Item, IAttachableToEntity, IAttachedInteractions, IAttachedListener
{
	private CompositeShape loweredShape;
	...
	{
		if (!stack.Attributes.GetBool("lowered"))
		{
			return Shape;
		}
		return loweredShape;

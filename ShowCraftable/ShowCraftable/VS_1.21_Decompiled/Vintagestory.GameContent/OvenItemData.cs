...
public class OvenItemData
{
	...
	{
		BakingProperties bakingProperties = BakingProperties.ReadFrom(stack);
		BrowningPoint = bakingProperties.Temp ?? 160f;
		...
		BakedLevel = bakingProperties.LevelFrom;
		CurHeightMul = bakingProperties.StartScaleY;
		temp = 20f;
	}

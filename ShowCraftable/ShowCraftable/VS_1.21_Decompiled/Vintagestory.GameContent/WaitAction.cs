...
public class WaitAction : EntityActionBase
{
	...
	public override void AddGuiEditFields(ICoreClientAPI capi, GuiComposer singleComposer)
	{
		...
		singleComposer.AddStaticText("Wait IRL seconds", CairoFont.WhiteDetailText(), elementBounds).AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "wait");

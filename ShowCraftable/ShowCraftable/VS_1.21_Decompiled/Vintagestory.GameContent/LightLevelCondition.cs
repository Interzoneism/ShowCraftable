...
public class LightLevelCondition : IActionCondition, IStorableTypedComponent
{
	...
	public void AddGuiEditFields(ICoreClientAPI capi, GuiComposer singleComposer)
	{
		...
		singleComposer.AddStaticText("Light level type", CairoFont.WhiteDetailText(), elementBounds).AddDropDown(values, names, (int)lightLevelType, null, elementBounds = elementBounds.BelowCopy(0.0, -5.0), CairoFont.WhiteDetailText(), "lightleveltype").AddStaticText("Min light level (0..32)", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 10.0))
			.AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "minLight")
			.AddStaticText("Max light level (0..32)", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 10.0))
			.AddNumberInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "maxLight");

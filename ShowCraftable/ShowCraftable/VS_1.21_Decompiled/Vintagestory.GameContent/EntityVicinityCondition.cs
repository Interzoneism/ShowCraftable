...
public class EntityVicinityCondition : IActionCondition, IStorableTypedComponent
{
	...
	{
		return ep.GetNearestEntity(vas.Entity.Pos.XYZ, range, (Entity entity) => entity.WildCardMatch(entityCode), EnumEntitySearchType.Creatures) != null;
	}
	...
	public void AddGuiEditFields(ICoreClientAPI capi, GuiComposer singleComposer)
	{
		...
		singleComposer.AddStaticText("Range", CairoFont.WhiteDetailText(), elementBounds).AddTextInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "range").AddStaticText("EntityCode", CairoFont.WhiteDetailText(), elementBounds = elementBounds.BelowCopy(0.0, 10.0))
			.AddTextInput(elementBounds = elementBounds.BelowCopy(0.0, -5.0), null, CairoFont.WhiteDetailText(), "entityCode");

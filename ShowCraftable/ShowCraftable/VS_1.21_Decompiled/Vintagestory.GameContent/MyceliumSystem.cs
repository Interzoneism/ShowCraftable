...
public class MyceliumSystem : ModSystem
{
	...
	{
		BlockPos asBlockPos = args.Caller.Entity.Pos.XYZ.AsBlockPos;
		if (!(api.World.BlockAccessor.GetBlockEntity(asBlockPos.DownCopy()) is BlockEntityMycelium blockEntityMycelium))
		{
			return TextCommandResult.Success("No mycelium below you");
		}
		blockEntityMycelium.Regrow();

...
public class ClientProgramArgs
{
	...
	{
		HelpText obj = HelpText.AutoBuild<ClientProgramArgs>(parser, (Func<HelpText, HelpText>)((HelpText h) => h), (Func<Example, Example>)((Example e) => e), false, 80);
		obj.Heading = "Vintage Story Client 1.21.0";

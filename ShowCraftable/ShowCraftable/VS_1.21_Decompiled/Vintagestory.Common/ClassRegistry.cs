...
public class ClassRegistry
{
	...
	{
		string key = tree.GetString("className");
		if (mountableEntries.TryGetValue(key, out var value))
		{
			return value(world, tree);
		}
		return null;
	}
	...
	{
		if (!inventoryClassToTypeMapping.TryGetValue(inventoryClass, out var value))
		{
			throw new Exception("Don't know how to instantiate inventory of class '" + inventoryClass + "' did you forget to register a mapping?");
		}
		try
		{
			return (InventoryBase)Activator.CreateInstance(value, inventoryId, api);
		}
		catch (Exception ex)
		{
	...
	{
		if (!RecipeRegistryToTypeMapping.TryGetValue(recipeRegistryCode, out var value))
		{
	...
	public Block CreateBlock(string blockClass)
	{
		...
		try
		{
			return (Block)Activator.CreateInstance(value);
		}
		catch (Exception ex)
		{
	...
	{
		BlockClassToTypeMapping.TryGetValue(blockClass, out var value);
		return value;
	}
	...
	{
		if (!blockbehaviorToTypeMapping.TryGetValue(blockClass, out var value))
		{
		...
		try
		{
			return (BlockBehavior)Activator.CreateInstance(value, block);
		}
		catch (Exception ex)
		{
	...
	{
		if (!blockentitybehaviorToTypeMapping.TryGetValue(blockEntityClass, out var value))
		{
		...
		try
		{
			return (BlockEntityBehavior)Activator.CreateInstance(value, blockentity);
		}
		catch (Exception ex)
		{
	...
	{
		if (!collectibleBehaviorToTypeMapping.TryGetValue(code, out var value))
		{
		...
		try
		{
			return (CollectibleBehavior)Activator.CreateInstance(value, collectible);
		}
		catch (Exception ex)
		{
	...
	{
		collectibleBehaviorToTypeMapping.TryGetValue(code, out var value);
		return value;
	}
	...
	{
		if (!cropbehaviorToTypeMapping.TryGetValue(cropBehaviorClass, out var value))
		{
		...
		try
		{
			return (CropBehavior)Activator.CreateInstance(value, block);
		}
		catch (Exception ex)
		{
	...
	public Item CreateItem(string itemClass)
	{
		...
		try
		{
			return (Item)Activator.CreateInstance(value);
		}
		catch (Exception ex)
		{
	...
	{
		ItemClassToTypeMapping.TryGetValue(itemClass, out var value);
		return value;
	}
	...
	public Entity CreateEntity(string className)
	{
		...
		try
		{
			return (Entity)Activator.CreateInstance(value);
		}
		catch (Exception ex)
		{
			throw new Exception($"Error on instantiating entity '{value}':\n{ex}", ex);
		}
	}

	public void RegisterEntityRendererType(string className, Type EntityRenderer)
	{
		if (EntityRendererClassNameToTypeMapping.TryGetValue(className, out var value))
		{
			EntityRendererTypeToClassNameMapping.Remove(value);
		}
	...
	public EntityRenderer CreateEntityRenderer(string className, params object[] args)
	{
		...
		return (EntityRenderer)Activator.CreateInstance(value, args);
	}

	public Type GetEntityBehaviorClass(string entityBehaviorName)
	{
		entityBehaviorClassNameToTypeMapping.TryGetValue(entityBehaviorName, out var value);
		return value;
	}
	...
	public EntityBehavior CreateEntityBehavior(Entity forEntity, string className)
	{
		...
		try
		{
			return (EntityBehavior)Activator.CreateInstance(value, forEntity);
		}
		catch (Exception ex)
		{
	...
	public BlockEntity CreateBlockEntity(string className)
	{
		...
		try
		{
			return (BlockEntity)Activator.CreateInstance(value);
		}
		catch (Exception ex)
		{
	...
	{
		if (!ParticleProviderClassnameToTypeMapping.TryGetValue(className, out var value))
		{
			throw new Exception("Don't know how to instantiate entity of type '" + className + "' did you forget to register a mapping?");
		}
		return (IParticlePropertiesProvider)Activator.CreateInstance(value);
	}
